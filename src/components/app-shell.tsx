...
import { BarChart3, Bell, CalendarDays, ChevronDown, House, LogOut, Scissors, Settings, UserRoundCog, UsersRound, Menu, X, Package, Clock, UserRound, Store } from "lucide-react";
