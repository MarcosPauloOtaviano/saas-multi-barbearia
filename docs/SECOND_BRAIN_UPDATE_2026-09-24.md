...
- Nas listas públicas, mostrar apenas nome, descrição real quando existir, duração, preço e ação. Conta do cliente e senha não devem ocupar a navegação principal.
